...
//StoreAppInterface is a mock store app interface
type StoreAppInterface struct {
	GetAllStoreFn func(map[string]interface{}) ([]entity.Store, error)
	GetStoreFn    func(uint64) (*entity.Store, error)
}

func (s *StoreAppInterface) GetAllStore(options map[string]interface{}) ([]entity.Store, error) {
	return s.GetAllStoreFn(options)
}

func (s *StoreAppInterface) GetStoreDetail(storeId uint64) (*entity.Store, error) {
	return s.GetStoreFn(storeId)
}
