...
import (
	...
	"github.com/zainafifaldi/digicafe/infrastructure/security"
)

type User struct {
	ID        uint64     `json:"primary_key;auto_increment" json:"id"`
	FirstName string     `json:"size:100;not null;" json:"first_name"`
	LastName  string     `json:"size:100;not null;" json:"last_name"`
	Email     string     `json:"size:100;not null;unique" json:"email"`
	Password  string     `json:"size:100;not null;" json:"password"`
